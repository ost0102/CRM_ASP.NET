...
#Region "=================Data logic actions==========="
    Private Function GetConvertToDataSet() As DataSet
        ...
        Try
            ...
            YJSql.SqlBox("WG1", "CrmAsMgt@Search", True)
            ...
            YJSql.Params("USR_DEPT_CD", ClientSessionInfo.OrganizationCode)
            '
    ...
    Public Sub SearchDataOld(ByVal MngtNo As String)
        ...
        Try
            YJIT.SC.WCF.WCFBiz.Instance.MethodCallAsync("YJIT.Biz.CrmAsMgt", "SearchOld", params, AddressOf SearchOnComplete)
    ...
    Private Sub SearchOnComplete(ByVal sender As Object, ByVal e As WCF.SRBiz.MethodCallCompletedEventArgs)
        Try
            ...
            Me.ClearView(UI.AppliedRangeTypes.Except, {SEARCH_KEY, FM_YMD, TO_YMD, POPUP_INPUT, S_ROW_BEST, REF_TIME, S_PRIORITY, S_WORK_USR})
    ...
    Private Function SearchValidate() As Boolean
        ...
        Try
            If String.IsNullOrEmpty(FM_YMD.Text) Then
                ...
                ErrMsg &= "Please input the [" & lbl_FM_YMD.Text & "]" & vbNewLine
            End If
    ...
    Private Sub NewData()
        ...
        ClearView(UI.AppliedRangeTypes.Except, {WG1, SEARCH_KEY, S_ROW_BEST, S_PROC_TYPE, POPUP_INPUT, REF_TIME, S_PRIORITY, S_WORK_USR})
...
#Region "=================Control Events==========="
    Private Sub CrmAsMgt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub CrmAsMgt_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown

        Call InitData()
        Call GridInit()

        SaveControlValues(Me, {WG1, POPUP_INPUT, FM_YMD, TO_YMD, S_ROW_BEST, S_WORK_USR, S_PRIORITY, S_PROC_TYPE, REF_TIME})
        ...
        S_DEPT_CD.EditValue = ClientSessionInfo.OrganizationCode
    ...
    Private Sub S_DEPT_CD_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles S_SVC_CD.KeyUp, S_DEPT_CD.KeyUp, S_DEPT_AUTH_LIST.KeyUp
