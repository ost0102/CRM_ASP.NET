...
Namespace YJIT.BIZ
    Public Class CrmFriendAprMgt
        ...
        Public Shared Function Search(ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            db = New DBA(CrmSvcAprMgt.GetConnectionString("FRIEND_SYS", ""), "ORACLE")
        ...
        Public Shared Function Save(ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            Dim dbFREIND As DBA = New DBA(CrmSvcAprMgt.GetConnectionString("FRIEND_SYS", ""), "ORACLE")
            ...
            Return resultSet
        End Function
        Public Shared Function FileDownload(ByVal mngt_no As String, ByVal usr_id As String, ByVal auth_key As String) As Dictionary(Of String, Object)
            ...
            Dim apiurl As String = "http://apifriend.yjit.co.kr/api/UserData/GetLicensePath"
        ...
        Private Shared Function GetRestAPI(ByVal methodParam As String, ByVal urlParam As String, ByVal tokenParam As String, ByVal dataParam As String) As String
            ...
            request.Headers.Add("Authorization-Type", "Y")
            ...
            Try
                ...
                For Each dr As DataRow In ds.Tables("EMAIL_INFO").Rows
                    Try
                        ...
                        If Not ds.Tables.Contains("EMAIL_TYPE") Then
                            '파일 첨부 로직 추가
                        ...
                        Dim colorbackground As String = "#f49f17"
                        Dim OfficeName As String = "양재아이티"
                        ...
                        sBody &= "            <td valign=""middle"" style=""padding:0 13px;background-color: " & colorbackground & ";color: #ffffff;font-size: 20px;height:70px;letter-spacing:-1px;font-family:'Noto Sans KR', 'Noto Sans', 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif;"">" & Chr(13) & Chr(10)
                        sBody &= " 						              <div style='max-width: 610px;margin: 0 auto'> 안녕하세요. <strong style='font-size:20px;'>" & OfficeName & "</strong> 입니다.</div>" & Chr(13) & Chr(10)
                        sBody &= "            </td>" & Chr(13) & Chr(10)
                        sBody &= "         </tr>" & Chr(13) & Chr(10)

                        If dr("SUB_TITLE").ToString <> "" Then
                            sBody &= "         <tr>" & Chr(13) & Chr(10)
                            sBody &= "            <td valign=""top"" align=""center"" style=""padding:50px 0;background-color: #ffffff;color: #666666;font-size: 20px;letter-spacing:-1px;font-family:'Noto Sans KR', 'Noto Sans', 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif;font-weight: 300;"">" & Chr(13) & Chr(10)
                            sBody &= "               <span style=""font-size:16px; font-weight: 600;color: #111111;"">" & dr("SUB_TITLE").ToString & "</span>" & Chr(13) & Chr(10)
                            sBody &= "            </td>" & Chr(13) & Chr(10)
                            sBody &= "         </tr>" & Chr(13) & Chr(10)
                        End If
                        ...
                        sBody &= "         <tr>" & Chr(13) & Chr(10)
                        sBody &= "            <td valign=""top"">" & Chr(13) & Chr(10)
                        sBody &= "               <div style=""max-width: 700px;margin: 0 auto"">" & Chr(13) & Chr(10)
                        ...
                        For Each drContent As DataRow In ds.Tables("EMAIL_CONTENT").Rows
                            If drContent("MNGT_NO").ToString = dr("MNGT_NO").ToString Then
                                ...
                                sBody &= "                <tr>" & Chr(13) & Chr(10)
                                sBody &= "                        <td valign=""middle"" align=""center"" width=""28%"" style=""width:28%;padding:0;height:43px;font-size: 14px;color: #333333;background-color: #f8f8f8;border-bottom: 1px solid #eaeaea;font-family:'Noto Sans KR', 'Noto Sans', 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif;font-weight: 600;"">" & Chr(13) & Chr(10)
                                ...
                                sBody &= " 				              <span>" & drContent("DATA").ToString & "</span> " & Chr(13) & Chr(10)
                                sBody &= "                        </td> " & Chr(13) & Chr(10)
                                If ds.Tables("EMAIL_CONTENT").Columns.Contains("COLUMN2") AndAlso ds.Tables("EMAIL_CONTENT").Columns.Contains("DATA2") Then
                                    ...
                                    sBody &= "                    </td>  "
                                    sBody &= "                        <td valign=""middle"" align=""left"" style=""padding:0 0 0 20px;height:43px;font-size: 14px;color: #888888;border-bottom: 1px solid #eaeaea;font-family:'Noto Sans KR', 'Noto Sans', 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif;font-weight: 300;"">" & Chr(13) & Chr(10)
                                    sBody &= " 				          <span>" & drContent("DATA2").ToString & "</span> " & Chr(13) & Chr(10)
                                    sBody &= "                     </td> "
                                End If
                                sBody &= "                </tr>" & Chr(13) & Chr(10)
                            End If
                        ...
                        'PrmBookingList, PrmBookingList_v1 동일로직
                        Select Case ds.Tables("EMAIL_INFO")(0)("PKGE_TYPE").ToString
                            Case "HOTSALE", "USR_D", "USR_S", "USR_P"
                                '자세히보기 미표시 / USR_D 거절, USR_S 중지
                            Case Else
                                sBody &= "         <tr>"
                                ...
                                sBody &= "                              <tr>"
                                sBody &= "                                 <td>"
                                sBody &= "                                       <table style=""table-layout:fixed;width:100%;background:" & colorbackground & """ border=""0"" cellpadding=""0"" cellspacing=""0"">"
                                sBody &= "                                           <tbody>"
                                sBody &= "                                              <tr>"
                                ...
                                If ds.Tables("EMAIL_INFO")(0)("PKGE_TYPE").ToString <> "USR" Then
                                    sBody &= "                                                       <a href=""#"" style=""text-decoration:none !important; font-size:18px;color:#fff;text-decoration:none;font-family:'Noto Sans KR', 'Noto Sans', 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif;font-weight: 600;text-decoration: none;"" rel=""noreferrer noopener"" target=""_blank"">" & dr("BTN_NM").ToString & "</a>"
                                ...
                                Else
                                    sBody &= "                                                       <a href=" & dr("BTN_URL").ToString & " style=""text-decoration:none !important; font-size:18px;color:#fff;text-decoration:none;font-family:'Noto Sans KR', 'Noto Sans', 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif;font-weight: 600;text-decoration: none;"" rel=""noreferrer noopener"" target=""_blank"">" & dr("BTN_NM").ToString & "</a>"
                                End If
                        ...
                        'sql = New SqlBox("CrmFriendAprMgt@InsertMailAuthkey")
        ...
        '                sql = New SqlBox("CrmFriendAprMgt@UnlockPassword")
        ...
        '                sql = New SqlBox("CrmFriendAprMgt@SearchUnlockPassword")
        '                sql.Params("EMAIL") = dr("EMAIL")
        '                Dim dt As DataTable = db.SqlGet(sql.Text)

        '                sql = New SqlBox("CrmFriendAprMgt@InsertLog")
        '                sql.Params("EMAIL") = dr("EMAIL")
        ...
        '    Dim sql As SqlBox = Nothing
        '    Dim ErrorOccur As Boolean = True
        '    Dim dbOLD As New DBA(CrmSvcAprMgt.GetConnectionString("ELVIS_FRIEND", ""), "ORACLE")
        '    Dim dbADMIN As New DBA(CrmSvcAprMgt.GetConnectionString("ELVIS_FRIEND", ""), "ORACLE")
        ...
        '            Dim dbNEW As New DBA(CrmSvcAprMgt.GetConnectionString("NEW", row("ELVIS_ID").ToString), "ORACLE")
