...
#Region "=================GetConvertToDataset Function==========="
    Private Function GetConvertToDataSet(ByVal Type As String) As DataSet
        ...
        Select Case Type.ToUpper
            Case "SEARCH"
                YJSql.SqlBox("WG1", "EvbDiscountSet@Search")
        End Select
...
#Region "=================Control Events==========="
    Private Sub btnSearch_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Call SearchData()
    End Sub
    Private Sub EvbDiscountSet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    End Sub
    Private Sub EvbDiscountSet_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Call PopupInit()
