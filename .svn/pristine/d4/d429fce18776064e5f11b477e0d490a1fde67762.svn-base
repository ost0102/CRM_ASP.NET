...
#Region "=================Data logic actions==========="
    Public Sub SearchData()
        ...
        Try
            YJIT.SC.WCF.WCFBiz.Instance.MethodCallAsync("YJIT.Biz.MdmExrateMgt_v1", "Search", Me.ConvertToDataset, AddressOf search_OnComplete)
    ...
    Public Sub SaveData()
        ...
        Try
            dsRet = YJIT.SC.WCF.WCFBiz.Instance.MethodCall("YJIT.Biz.MdmExrateMgt_v1", "Save", params)
        Catch ex As Exception
            MsgBoxLocalized(ex.Message)
            Exit Sub
        End Try
    ...
    Public Sub DeleteData()
        ...
        Try
            dsRet = YJIT.SC.WCF.WCFBiz.Instance.MethodCall("YJIT.Biz.MdmExrateMgt_v1", "Delete", Me.ConvertToDataset)
        Catch ex As Exception
            MsgBoxLocalized(ex.Message)
            Exit Sub
        End Try
    ...
    Public Sub CopyData()
        ...
        Dim dsRet As DataSet
        Try
            dsRet = YJIT.SC.WCF.WCFBiz.Instance.MethodCall("YJIT.Biz.MdmExrateMgt_v1", "Copy", params)
        Catch ex As Exception
            MsgBoxLocalized(ex.Message)
            Exit Sub
        End Try
...
#Region "=================Control Events==========="
    ...
    Private Sub btnCopyExchangeRate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCopyExchangeRate.Click
        Call CopyData()
    End Sub
    Private Sub MdmExrateMgt_v1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call SetMandatoryLine(Me)
        Call InitGrid()
        Call DrawRowIndicator({ABGV1})
    End Sub
    Private Sub MdmExrateMgt_v1_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        Call PopupInit()
