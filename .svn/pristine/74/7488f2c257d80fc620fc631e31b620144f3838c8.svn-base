...
#Region "=================GetConvertToDataSet Function==========="
    Private Function GetConvertToDataSet() As DataSet
        ...
        Try
            YJSql.SqlBox("WG1", "YjediSpecMgt@Search", False, True)
            ...
            YJSql.Params("SEND_ID", SEND_ID.Text.Trim)
...
#Region "=================Client Function=============="
    ...
    Private Sub PopupInit()
        ...
        WG1_PopUp.PopUpInit(Me, WG1, btnQuickWg1, "CUSTOMS_CD", "USE_YN")
    End Sub
    ...
    Private Sub InitGrid()
        ...
        GV1.Columns("SEND_TYPE").ColumnEdit = GridFunc.GetRepositoryItemLookUpEdit({"DIR:DIR", "FTP:FTP", "SFTP:SFTP", "XML:XML", "T:TEST"})
        GV1.Columns("RECV_TYPE").ColumnEdit = GridFunc.GetRepositoryItemLookUpEdit({"DIR:DIR", "FTP:FTP", "SFTP:SFTP", "XML:XML", "T:TEST"})
    End Sub
                ...
                Select Case Sender
                    Case "WG1"
                        ...
                        Else
                            ...
                            GV1.SetFocusedRowCellValue("SEND_ID", GV1.GetRowCellValue(GV1.FocusedRowHandle - 1, "SEND_ID").ToString)
                            GV1.SetFocusedRowCellValue("RECV_ID", GV1.GetRowCellValue(GV1.FocusedRowHandle - 1, "RECV_ID").ToString)
                            GV1.SetFocusedRowCellValue("SEND_TYPE", GV1.GetRowCellValue(GV1.FocusedRowHandle - 1, "SEND_TYPE").ToString)
                            GV1.SetFocusedRowCellValue("RECV_TYPE", GV1.GetRowCellValue(GV1.FocusedRowHandle - 1, "RECV_TYPE").ToString)
                        End If
                End Select
        End Select
    End Sub
...
#Region "=================Data logic actions==========="
    ...
    Public Sub SearchData()
        ...
        ds = Func.MethodCall(Me, "YJIT.Biz.YjediSpecMgt", "Search", {ds})
    ...
    Public Sub SaveData()
        Try
            ...
            ds = Func.MethodCall(Me, "YJIT.Biz.YjediSpecMgt", "Save", {ds})
            Dim drPairs As DataRow = ds.Tables("KEY_VALUE_PAIRS").Rows(0)
