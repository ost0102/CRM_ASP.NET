Public Class SysSmartHelp_HyperLink
    ...
    Private Sub SysSmartHelp_HyperLink_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If ProjectRoot <> "" Then
            Call loadHelpRoots()
        End If
    End Sub
