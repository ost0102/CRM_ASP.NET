Public Class CrmCustomerUpload
    ...
    Private Sub CrmCustomerUpload_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub startUpload()
        ...
        For i As Integer = 0 To ArlClientFiles.Count - 1
            ...
            sResult = Common.UploadFile(sFilePath, sFileName, "?Flag=ALL&URI=/WCF/CRM/Data/CRM_" & BoardId & "_files/")
