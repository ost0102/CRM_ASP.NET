Public Class SysSmartHelp_Popup
    ...
    Public Sub LoadNodeInfo(ByVal sNodeId As String)
        ...
        Try
            dsResult = YJIT.SC.WCF.WCFBiz.Instance.MethodCall("YJIT.Sys.SysSmartHelp", "GetNodeProperties", params)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim drPairs As DataRow
        Try
            dsResult = YJIT.SC.WCF.WCFBiz.Instance.MethodCall("YJIT.Sys.SysSmartHelp", "UpdateNodeProperties", params)
        Catch ex As Exception
            MsgBoxSC(ex.Message)
            Exit Sub
        End Try
