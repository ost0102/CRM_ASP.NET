...
Partial Class WCF_Client_Manifest
    ...
    Private Sub loadFileManifest()
        ...
        For Each sFile As String In files
            ...
            If sFile.Contains("\Manifest.aspx") Then Continue For
            If sFile.Contains("\Manifest.aspx.vb") Then Continue For
            If sFile.Contains("\Downloader.aspx") Then Continue For
            If sFile.Contains("\Downloader.aspx.vb") Then Continue For
            ...
            If Request("SingleFileURI") <> "" Then
                ...
                If (locFile = sSubUrl.ToUpper()) OrElse _
