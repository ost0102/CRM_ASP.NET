    ...
    Public Class CrmCustomizing
        ...
        Public Shared Function Search(ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            Try
                ...
                '커스터마이즈 리스트
                sql = New SqlBox("CrmCustomizing@SearchList")
        ...
        Public Shared Function SearchDetail(ByVal MNGT_NO As String, ByVal CUST_CD As String) As Dictionary(Of String, Object)
            ...
            Try
                ...
                sql = New SqlBox("CrmCustomizing@SearchMain")
                ...
                '비용사용내역
                sql = New SqlBox("CrmCustomizing@SearchItem")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
                dt.TableName = "WG2"
                ...
                '자금 집행 계획 
                sql = New SqlBox("CrmCustomizing@SearchFund")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
                dt.TableName = "WG3"
                ...
                '견적서 
                sql = New SqlBox("CrmCustomizing@SearchEstm")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
                dt.TableName = "WG4"
        ...
        Public Shared Function Print(ByVal MNGT_NO As String, ByVal CUST_CD As String) As Dictionary(Of String, Object)
            ...
            Try
                sql = New SqlBox("CrmCustomizing@PrintList")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
                ...
                sql = New SqlBox("CrmCustomizing@PrintItem")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
                ...
                sql = New SqlBox("CrmCustomizing@PrintFund")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
                ...
                sql = New SqlBox("CrmCustomizing@PrintEstm")
                sql.Params("MNGT_NO") = MNGT_NO
                sql.Params("CUST_CD") = CUST_CD
                dt = db.SqlGet(sql.Text, False)
        ...
        Public Shared Function Save(ByVal insFlag As String, ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            Try
                ...
                sql = New SqlBox("CrmCustomizing@MakeMngtno")
                ...
                Select Case insFlag
                    Case "I"
                        sql = New SqlBox("CrmCustomizing@Insert")
                        sql.Params("MNGT_NO") = MngtNo
                    Case "U"
                        sql = New SqlBox("CrmCustomizing@Update")
                        sql.Params("MNGT_NO") = drHeader("MNGT_NO").ToString
                    Case "D"
                        sql = New SqlBox("CrmCustomizing@DeleteList")
                        sql.Params("MNGT_NO") = drHeader("MNGT_NO").ToString
                End Select
                ...
                For Each dr2 In dt.Rows
                    Select Case dr2("_INSFLAG")
                        Case "I"
                            sql = New SqlBox("CrmCustomizing@InsertItem")
                            If drHeader("MNGT_NO").ToString = "" Then
                                sql.Params("MNGT_NO") = MngtNo
                            End If
                        Case "U"
                            sql = New SqlBox("CrmCustomizing@UpdateItem")
                        Case "D"
                            sql = New SqlBox("CrmCustomizing@DeleteItem")
                        Case Else
                            Continue For
                    End Select
                ...
                For Each dr2 As DataRow In dt.Rows
                    Select Case dr2("_INSFLAG")
                        Case "I"
                            sql = New SqlBox("CrmCustomizing@InsertFund")
                            If drHeader("MNGT_NO").ToString = "" Then
                                sql.Params("MNGT_NO") = MngtNo
                            End If
                        Case "U"
                            sql = New SqlBox("CrmCustomizing@UpdateFund")
                        Case "D"
                            sql = New SqlBox("CrmCustomizing@DeleteFund")
                        Case Else
                            Continue For
                    End Select
                ...
                For Each dr2 In dt.Rows
                    Select Case dr2("_INSFLAG")
                        Case "I"
                            sql = New SqlBox("CrmCustomizing@InsertEstm")
                            If drHeader("MNGT_NO").ToString = "" Then
                                sql.Params("MNGT_NO") = MngtNo
                            End If
                        Case "U"
                            sql = New SqlBox("CrmCustomizing@UpdateEstm")
                        Case "D"
                            sql = New SqlBox("CrmCustomizing@DeleteEstm")
                        Case Else
                            Continue For
                    End Select
        ...
        Public Shared Function Delete(ByVal CustCode As String, ByVal MngtNo As String) As Dictionary(Of String, Object)
            ...
            Try
                ...
                sql = New SqlBox("CrmCustomizing@Delete")
                sql.Params("CUST_CD") = CustCode
                sql.Params("MNGT_NO") = MngtNo
                db.SqlSet(sql.Text)
