    ...
    Public Class CrmAsMgt_v3
        Public Shared Function SaveInput(ByVal ds As DataSet, ByVal strUploadPath As String) As Dictionary(Of String, Object)
            ...
            Try
                ...
                Select Case insflag
                    Case "I"
                        sql = New SqlBox("CrmAsMgt_v3@Insert")
                    Case "U"
                        ...
                        sql = New SqlBox("CrmAsMgt_v3@Update")
                    Case "D"
                        sql = New SqlBox("CrmAsMgt_v3@Delete")
                End Select
                ...
                sql = New SqlBox("CrmAsMgt_v3@Update2")
                sql.Params("MNGT_NO") = MngtNo
                db.SqlSet(sql.Text)
                ...
                '    sql = New SqlBox("CrmAsMgt_v3@InsertPicInfo")
                ...
                For Each DR In dt.Rows
                    Select Case DR("_INSFLAG")
                        Case "I"
                            sql = New SqlBox("CrmAsMgt_v3@InsertWorkDetail")
                        Case "U"
                            sql = New SqlBox("CrmAsMgt_v3@UpdateWorkDetail")
                        Case "D"
                            sql = New SqlBox("CrmAsMgt_v3@DeleteWorkDetail")
                    End Select
                ...
                '부서 권한 재설정 
                sql = New SqlBox("CrmAsMgt_v3@UpdateShareFlag")
                sql.Params("MNGT_NO") = MngtNo
                db.SqlSet(sql.Text)
                ...
                For Each Dept In DeptAuth
                    ...
                    sql = New SqlBox("CrmAsMgt_v3@InsertShareData")
                    sql.Params("MNGT_NO") = MngtNo
                ...
                Dim RtnDic As Dictionary(Of String, Object) = Search(ds)
                Dim RtnDS As New DataSet
                Dim RtnDS1 As New DataSet
                RtnDic.TryGetValue("Data", RtnDS)
                If RtnDS Is Nothing Then
                    RtnDS = New DataSet
                End If
                ds.Tables("MAIN").Rows(0)("MNGT_NO") = MngtNo
                RtnDic = SearchInput(ds)
                RtnDic.TryGetValue("Data", RtnDS1)
                If RtnDS1 Is Nothing Then
                    RtnDS1 = New DataSet
                End If
                RtnDS.Merge(RtnDS1)

                'SearchInput
                resultSet("Data") = RtnDS
        ...
        Public Shared Function SearchInput(ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            Try
                ...
                sql = New SqlBox("CrmAsMgt_v3@SearchInput")
                ...
                sql = New SqlBox("CrmAsMgt_v3@SearchWorkDetail")
                sql.Params("MNGT_NO") = drHeader("MNGT_NO").ToString
                dt = db.SqlGet(sql.Text, False)
                dt.TableName = "WG3"
                ResultDs.Tables.Add(dt)

                sql = New SqlBox("CrmAsMgt_v3@SearchHistory")
        ...
        Public Shared Function SearchCustomer(ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            Try
                ...
                sql = New SqlBox("CrmAsMgt_v3@SearchCustomer")
        ...
        '        sql = New SqlBox("CrmAsMgt_v3@SearchCustomerPic")
        '        sql.Params("CUST_CD") = drHeader("CUST_CD").ToString
        ...
        Public Shared Function Search(ByVal ds As DataSet) As Dictionary(Of String, Object)
            ...
            Try
                ...
                sql = New SqlBox("CrmAsMgt_v3@Search")
                sql.AllowSqlInjection = True
