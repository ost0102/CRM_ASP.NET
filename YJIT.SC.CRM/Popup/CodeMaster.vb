Public Class CodeMaster
    ...
    Protected Overrides Sub OnShown(ByVal e As System.EventArgs)
        ...
        'Set initial value for keyword from the current code value
        'txtKeyword.Text = Me.ParentCodeBox.Text
        'Perform search as soon as shown
    ...
    Protected Overrides Sub ExecuteSearch(Optional ByVal nPage As Integer = 1)
        'Important: Before Execute, set the SearchKey
        Me.SearchParamValues("SearchKey") = Me.txtKeyword.Text.Trim
        Me.SearchParamValues("SEARCH_TYPE") = ""
    ...
    Private Sub LinkPage_MouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        If e.Button = System.Windows.Forms.MouseButtons.Left Then
            Dim nPage As Integer = CType(sender, LinkLabel).AccessibleDescription
            _searchCode(nPage)
        End If
    End Sub
    Private Sub LinkPage_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    End Sub
    Private Sub LinkPage_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        Me.ClearView()
    End Sub
    Private Sub txtKeyword_PreviewKeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PreviewKeyDownEventArgs) Handles txtKeyword.PreviewKeyDown
