...
Public Class HelpCommon
    ...
    Public Shared Function SetDbInfoSetting(ByVal Domain As String, ByRef DataInfo As Dictionary(Of String, String)) As Boolean
        ...
        If Domain = "" Then
            ...
            DataInfo("USR_ID") = HelpPswdReset.InI.ReadValue("SYSTEM", "USR_ID")
            DataInfo("USR_PWD") = HelpPswdReset.InI.ReadValue("SYSTEM", "USR_PWD")
            DataInfo("DB_IP") = HelpPswdReset.InI.ReadValue("SYSTEM", "DB_IP")
            DataInfo("DB_PORT") = HelpPswdReset.InI.ReadValue("SYSTEM", "DB_PORT")
            DataInfo("DB_SID") = HelpPswdReset.InI.ReadValue("SYSTEM", "DB_SID")
